...
from PyQt5.QtWidgets import (
    ...
    QSlider, QListWidget, QListWidgetItem, QGroupBox, QSplitter,
...
class MusicPlayer(QWidget):
    ...
    def __init__(self, downloads_path="downloads"):
        ...
        if not self.ffmpeg_available:
            warning_msg = ("FFmpeg não encontrado. "
                           "Controles de pitch desabilitados.")
        ...
        self.audio_processor = AsyncSimpleAudioProcessor(
    ...
    def adjust_speed(self, speed):
        ...
        for btn in [self.speed_slow_btn, self.speed_normal_btn,
                    self.speed_fast_btn]:
            btn.setStyleSheet("")
    ...
    def process_current_song(self):
        ...
        logging.info(f"Iniciando processamento: {self.current_song} "
        ...
        self.audio_processor.process_audio_async(
            self.current_song,
            pitch_shift=self.current_pitch
        )
    ...
    def save_processed_version(self):
        ...
        if not self.current_song or not self.has_processed_audio:
            QMessageBox.information(
                self,
                "Aviso",
                "Nenhuma música com tom alterado para salvar."
            )
            return
            ...
            if save_path:
                ...
                try:
                    ...
                    try:
                        ...
                        if (hasattr(original_file, 'tags') and
                                original_file.tags is not None):
                    ...
                    if audio_file.tags:
                        audio_file.tags["TIT2"] = TIT2(
                            encoding=3, text=new_title
                        )
